...
companyRouter.get('/search', authorizeRole('Company_HR') ,  searchCompanyByName)
companyRouter.get('/getApplications/:jobId' , authorizeRole('Company_HR'),  getApplicationsForJob)
