...
import { addJob, applyToJob, deleteJob, getAllJobsWithTheirsCompanies, getJobsOfSpacificCompany, updateJob } from "./job.controller.js";
...
JobRouter.post('/apply'  ,authorizeRole('User') , validate(applyToJobValSchema) , uploa applyToJob)
