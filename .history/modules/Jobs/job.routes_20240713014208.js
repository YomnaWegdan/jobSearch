...
import { addJob, deleteJob, getAllJobsWithTheirsCompanies, getJobsOfSpacificCompany, updateJob } from "./job.controller.js";
...
JobRouter.get('/' ,authorizeRole(['Company_HR' , 'User']) ,  getAllJobsWithTheirsCompanies)
