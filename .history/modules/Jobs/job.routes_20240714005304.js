...
import { addJob, applyToJob, deleteJob, getAllJobsWithTheirsCompanies, getJobsOfSpacificCompany, updateJob, uploadResume } from "./job.controller.js";
...
JobRouter.get('/filter' ,  getJobsOfSpacificCompany)



JobRouter.post('/apply'   , validate(applyToJobValSchema) , uploadResume , applyToJob)
