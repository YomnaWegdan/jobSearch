...
import { recoveryEmailSchema, signInSchema, signupValSchema, updatePasswordSchema, updateSchema } from "./user.validation.js";
...
userRouter.post('/resetPassword', validate(resetPAss), resetPassword);
